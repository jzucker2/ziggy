...
mqtt_connection_status = Gauge(
    ...
    labelnames=["broker_host", "broker_port"],
)
...
mqtt_connection_failures = Counter(
    ...
    labelnames=["broker_host", "broker_port", "reason"],
)
...
mqtt_message_processing_errors = Counter(
    ...
    labelnames=["topic", "broker_host", "error_type"],
)
...
mqtt_client_info = Info(
    ...
    labelnames=["client_id", "broker_host", "broker_port"],
)
...
class MQTTMetrics:
    ...
    def increment_messages_received(self, topic: str):
        ...
        labels = {"topic": topic, "broker_host": self.broker_host}
    ...
    def set_subscriptions_active(self, count: int):
        ...
        mqtt_subscriptions_active.labels(broker_host=self.broker_host).set(
            count
        )
